...
export default function HeroBanner() {
  ...
  return (
    <section className="relative w-full h-[85vh] md:h-screen min-h-[500px] md:min-h-[650px] overflow-hidden">
      ...
      {/* Base dark overlay for full readability */}
      <div className="absolute inset-0" style={{ background: "hsl(211 80% 4% / 0.55)" }} />
      {/* Strong center gradient for text readability */}
      <div
        className="absolute inset-0"
        style={{
          background:
            "linear-gradient(170deg, hsl(211 80% 6% / 0.85) 0%, hsl(211 80% 8% / 0.7) 50%, hsl(211 80% 10% / 0.4) 100%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, hsl(211 80% 6% / 0.85) 0%, hsl(211 80% 8% / 0.7) 60%, hsl(211 80% 6% / 0.6) 100%)",
        }}
      />
        ...
        >
          ...
          <motion.p
            ...
            style={{
              ...
              textShadow: "0 1px 10px hsl(211 80% 4% / 0.9)",
            }}
          >
          ...
          <h1
            ...
            style={{
              ...
              textShadow: "0 2px 20px hsl(211 80% 4% / 0.8), 0 1px 6px hsl(211 80% 4% / 0.9)",
            }}
          >
            ...
            <motion.span
              className="block"
              variants={fadeUp}
              style={{ color: "hsl(43 74% 70%)", textShadow: "0 2px 16px hsl(211 80% 4% / 0.9)" }}
            >
          ...
          <motion.p
            ...
            style={{
              ...
              color: "hsl(0 0% 95%)",
              textShadow: "0 1px 12px hsl(211 80% 4% / 0.9), 0 2px 4px hsl(211 80% 4% / 0.7)",
