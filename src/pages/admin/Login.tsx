    ...
    >
      ...
      >
        ...
        <div className="mt-6 p-4 rounded-xl border border-border bg-muted/50">
          <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2">Credenciais de Acesso</p>
          <div className="space-y-2">
            <div>
              <p className="text-xs text-foreground font-medium">Administrador Principal</p>
              <p className="text-xs text-muted-foreground">admin@newcreation.com</p>
              <p className="text-xs text-muted-foreground">Senha: NewCreation@2025</p>
            </div>
            <div className="border-t border-border pt-2">
              <p className="text-xs text-foreground font-medium">Flow Sistemas</p>
              <p className="text-xs text-muted-foreground">flowsistemas@gmail.com</p>
              <p className="text-xs text-muted-foreground">Senha: Flow@Admin2025</p>
            </div>
          </div>
        </div>
      </motion.div>
